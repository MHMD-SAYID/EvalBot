...
namespace GraduationProject.Controllers
{
    ...
    //    [HttpPost("Google")]
    //    public async Task<IActionResult> Test([FromBody] TokenModel model)
    //    {
    //        try
    //        {
    //            var GoogleUser = await GoogleJsonWebSignature.ValidateAsync(model.Token, new GoogleJsonWebSignature.ValidationSettings()
    //            {
    //                Audience = new[] { "213357481232-ll7rbg6sjhk8gvqfk29glu25kjg9f4qs.apps.googleusercontent.com" }
    //            });
